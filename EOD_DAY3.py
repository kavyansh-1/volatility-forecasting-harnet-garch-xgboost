...
from src.stat_tests import adf_test, ljung_box_test, compute_acf_pacf, plot_acf_pacf
...
def main():
    ...
    for ticker in TICKERS:
        ...
        all_results.append(diagnostics_for_ticker(ticker))
    ...
    lb_path = REPORTS_DIR / "day3_lb_results.csv"
